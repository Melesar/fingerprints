...
class ScannerDevice
{
    ...
    public static ScannerDevice instance()
    {
        return null;
    }
    ...
    {
        try {
            String libraryPath = System.getProperty("user.dir") + "\\bin\\RS_JNI.dll";
            System.load(libraryPath);

            int result = RealScan_JNI.RS_InitSDK("", 0);
...
class RealScan_JNI
{
    ...
    public static final int RS_CAPTURE_FLAT_LEFT_SIDE_PALM = 0x14;
    public static final int RS_CAPTURE_FLAT_RIGHT_SIDE_PALM = 0x15;
    public static final int RS_CAPTURE_FLAT_LEFT_WRITERS_PALM = 0x16;
    public static final int RS_CAPTURE_FLAT_RIGHT_WRITERS_PALM = 0x17;
    public static final int RS_CAPTURE_ROLL_FINGER_EX = 0x30;

    public static final int RS_CAPTURE_FLAT_MANUAL_INI = 0xfd;
    public static final int RS_CAPTURE_FLAT_MANUAL = 0xfe;
    public static final int RS_CAPTURE_ROLL_MANUAL = 0xff;
